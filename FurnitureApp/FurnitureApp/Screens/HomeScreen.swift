...
struct HomeScreen: View {
    @State private var selecatedIndex: Int = 0
        ...
        NavigationView {
           ZStack {
                ...
                ScrollView (.horizontal, showsIndicators: false) {
                    HStack {
                        ForEach(0 ..< categories.count) { i in
                            // If index == 1 isActive is true
                            categoryView(isActive: i == selecatedIndex, text: categories[i])
                                .onTapGesture {
                                    selecatedIndex = i
                                }
                         }
            ...
            HStack {
                ...
                BottomNavBar(image: Image("fav")) {}
                BottomNavBar(image: Image("shop")) {}
...
struct SearchAndScaneView: View {
